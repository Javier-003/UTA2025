        ...
        <div className="modal-dialog modal-dialog-right ">
          ...
          <div className="col-md-6">
            ...
            <div className="input-group mb-3">
              ...
              <textarea className="form-control" value={programaAcademicos} onChange={(event) => setprogramaAcademicos(event.target.value)} placeholder="Programa Académico" >
              </textarea>
            </div>
            <div className="input-group mb-3">
...
export default ProfesorModales;