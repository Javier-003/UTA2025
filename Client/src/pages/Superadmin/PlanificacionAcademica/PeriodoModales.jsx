            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <div className="input-group mb-3">
                  ...
                  <input type="date" className="form-control" value={fecha_inicio} onChange={(event) => setFechaInicio(event.target.value)} />
                </div>
                <div className="input-group mb-3">
                  <span className="input-group-text">Fecha Fin:</span>
                  <input type="date" className="form-control" value={fecha_fin} onChange={(event) => setFechaFin(event.target.value)} />
                </div>
