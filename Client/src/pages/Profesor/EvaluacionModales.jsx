...
export const EvaluacionModales = ({
  ...
  return (
    <>
      <div className={`modal fade ${showModal ? 'show' : ''}`} style={{ display: showModal ? 'block' : 'none' }} tabIndex="-1" aria-labelledby="modalLabel" aria-hidden="true" id="evaluacionModal">
        <div className="modal-dialog modal-dialog-right">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button type="button" className="btn btn-primary" onClick={handleSave}>Registrar</button>
            </div>
          </div>
        </div>
      </div>
